...
const Forecast = () => {
  ...
  const getForecast = (e) => {
    ...
    fetch(
      `https://community-open-weather-map.p.rapidapi.com/weather?units=metric&q=${uriEncodedCity},${uriEncodedCountry}`,
      {
        method: 'GET',
        headers: {
          'x-rapidapi-key':
            'fbdad90bfamsh6fefce3e8c34351p17aa3cjsn6ced871e2f14',
  ...
  return (
    <div>
      <form>
        ...
        <button type="submit" className="Button" onClick={getForecast}>
          Get Report
        </button>
      </form>
